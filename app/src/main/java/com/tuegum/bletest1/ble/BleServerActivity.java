package com.tuegum.bletest1.ble;
...
import com.tuegum.bletest1.APP;
import com.tuegum.bletest1.R;
...
public class BleServerActivity extends Activity {
    public static final UUID UUID_SERVICE = UUID.fromString("0000ff00-0000-1000-8000-00805f9b34fb"); //自定义UUID
    public static final UUID UUID_CHAR_READ_NOTIFY = UUID.fromString("0000ff01-0000-1000-8000-00805f9b34fb");
    public static final UUID UUID_DESC_NOTITY = UUID.fromString("0000ff01-0000-1000-8000-00805f9b34fb");
    public static final UUID UUID_CHAR_WRITE = UUID.fromString("0000ff02-0000-1000-8000-00805f9b34fb");
